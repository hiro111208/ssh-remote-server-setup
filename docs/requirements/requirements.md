...
Do not push your private key to any public repository. The solution to this project should just contain one solution.md file with the steps you took to complete the project.
